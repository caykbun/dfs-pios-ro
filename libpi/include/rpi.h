...
// put a single char
extern rpi_getchar_t rpi_getchar;

// override the routine.
rpi_putchar_t rpi_putchar_set(rpi_putchar_t putc);
#define rpi_set_putc rpi_putchar_set
void rpi_putchar_reset();

rpi_putchar_t rpi_getchar_set(rpi_getchar_t getc);
#define rpi_set_getc rpi_getchar_set
