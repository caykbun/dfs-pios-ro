...
ifndef CS140E_PROJECT_PATH
$(error CS140E_PROJECT_PATH is not set: this should contain the absolute path to where this directory is.  Define it in your shell's initialiation.  For example, .tcshrc for tcsh or .bashrc for bash)
endif
...
OD  = $(ARM)-objdump
OCP = $(ARM)-objcopy
CS140E_2023_LIBPI_PATH = $(CS140E_PROJECT_PATH)/libpi
